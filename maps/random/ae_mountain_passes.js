...
createMountains(tCliff, [avoidClasses(clPlayer, 35, clHill, 15, clBaseResource, 10, clWater, 20)], clHill, scaleByMapSize(5, 20) * numPlayers);

createHills([tMainTerrain, tCliff, tHill], [avoidClasses(clPlayer, 35, clHill, 15, clBaseResource, 10, clWater, 20)], clHill, scaleByMapSize(4, 16) * numPlayers);
...
createFood(
 ...
 avoidClasses(clForest, 3, clPlayer, 50, clWater, 5, clMetal, 30, clRock, 10, clHill, 1, clBaseResource, 20),
 clMetal
)
...
createFood(
 ...
 avoidClasses(clForest, 3, clPlayer, 50, clWater, 5, clMetal, 10, clRock, 30, clHill, 1, clBaseResource, 20),
 clRock
)
...
(
 ...
 avoidClasses(clForest, 2, clPlayer, 40, clWater, 2, clMetal, 5, clRock, 5, clFood, 30, clHill, 5, clBaseResource, 20) 
);

// create forests
createForests(
 [tMainTerrain, tForestFloor1, tForestFloor2, pForest1, pForest2],
 avoidClasses(clPlayer, 12, clWater, 10, clForest, 10, clHill, 15, clBaseResource, 5, clMetal, 5, clRock, 5, clFood, 5), 
 clForest,
 1.0,
 random_terrain
);
...
{	
    ...
    createStragglerTrees(types, avoidClasses(clForest, 5, clWater, 5, clPlayer, 10, clMetal, 5, clRock, 5, clFood, 5, clHill, 10, clBaseResource, 5));
}
