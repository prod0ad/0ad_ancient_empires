...
(
 ...
 [avoidClasses(clFood, 10, clRock, 1, clMetal, 1), stayClasses(clIsland, 6)]
);
...
createStragglerTrees(types, stayClasses(clIsland, 12), avoidClasses(clMetal, 4, clRock, 4, clForest, 16, clFood, 2));
