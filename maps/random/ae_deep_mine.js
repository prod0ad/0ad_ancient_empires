...
const lSize = sqrt(sqrt(sqrt(scaleByMapSize(1, 4))));

var placer = new ChainPlacer(2, floor(scaleByMapSize(5, 10)), floor(scaleByMapSize(8, 12)), 1, ix, iz, 0, [floor(mapSize * 0.06 * lSize)]);
var terrainPainter = new LayeredPainter(
	[tMainTerrain, tTier1Terrain, tTier1Terrain, tTier1Terrain],		// terrains
	[1, 4, 2]		// widths
);
...
createFood(
 ...
 [avoidClasses(clMetal, 5), stayClasses(clHill, 0)],
 clMetal
)
...
createFood(
 ...
 avoidClasses(clForest, 3, clPlayer, 50, clWater, 5, clMetal, 30, clRock, 40, clHill, 1, clBaseResource, 20, clFood, 5),
 clRock
)
...
createForests(
 ...
 avoidClasses(clPlayer, 20, clWater, 15, clForest, 25, clHill, 5, clBaseResource, 5, clMetal, 5, clRock, 5, clFood, 5), 
 clForest,
 1.0,
 random_terrain
);
...
(
 ...
 avoidClasses(clForest, 1, clPlayer, 40, clWater, 2, clMetal, 5, clRock, 5, clFood, 30, clHill, 5, clBaseResource, 10) 
);
